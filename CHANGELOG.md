...
![funfile-completion](https://github.com/alibaba/serverless-vscode/blob/zechen/v1.12.0/media/changelog/v1.12.0/funfile-completion.gif?raw=true)

- 模版文件 template.yml 自动补全优化。模版文件 template.yml 提供 MemorySize 可选值自动补全列表。

![memorySize-tip](https://github.com/alibaba/serverless-vscode/blob/zechen/v1.12.0/media/changelog/v1.12.0/memorySize-tip.gif?raw=true)
