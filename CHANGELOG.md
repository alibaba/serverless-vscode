...
![invokePanel](https://github.com/alibaba/serverless-vscode/blob/zechen/v1.11.0/media/changelog/v1.11.0/invokePanel.gif?raw=true)

- 本地资源树支持拷贝函数。在本地资源面板中，单击函数名后右键函数名选择复制或按 `ctrl/⌘ c`，再右键服务名选择黏贴或单击服务名后按 `ctrl/⌘ v`，即可将指定函数在模版文件 template.yml 中的相关描述定义拷贝到指定服务下。

![copy-paste](https://github.com/alibaba/serverless-vscode/blob/zechen/v1.11.0/media/changelog/v1.11.0/copy-paste.gif?raw=true)
