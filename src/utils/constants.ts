...
export const ALIYUN_SERVERLESS_TRIGGERS_TIMERR_TYPE = 'Timer';
export const ALIYUN_SERVERLESS_TRIGGERS_HTTP_TYPE = 'HTTP';
export const ALIYUN_SERVERLESS_TRIGGERS_LOG_TYPE = 'Log';
export const ALIYUN_SERVERLESS_TRIGGERS_OSS_TYPE = 'OSS';
export const ALIYUN_SERVERLESS_TRIGGERS_RDS_TYPE = 'RDS';
export const ALIYUN_SERVERLESS_TRIGGERS_MNSTOPIC_TYPE = 'MNSTopic';
export const ALIYUN_SERVERLESS_TRIGGERS_TABLESTORE_TYPE = 'TableStore';
export const ALIYUN_SERVERLESS_TRIGGERS_CDN_TYPE = 'CDN';
